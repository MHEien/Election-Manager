    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Add New Election manager</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="managers_add.php" enctype="multipart/form-data">
                      ...
                      <select class="form-control" id="election" name="election" required>
                        ...
                        <?php
                          ...
                          while($row = $query->fetch_assoc()){
                            echo "
                              <option value='".$row['id']."'>".$row['election']."</option>
                            ";
                          }
                        ?>
                      </select>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Edit Manager</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="managers_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="edit_election" name="election" required>
                        <option value="" selected id="eleelect"></option>
                        <?php
                          $sql = "SELECT * FROM election";
                          $query = $conn->query($sql);
                          while($row = $query->fetch_assoc()){
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="managers_delete.php">
                <input type="hidden" class="id" name="id">
