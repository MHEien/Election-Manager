<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="proof.php"><span class="glyphicon glyphicon-lock"></span> <span>Proof of Votes</span></a></li>
      <li class=""><a href="votesmissing.php"><span class="glyphicon glyphicon-lock"></span> <span>Missing Votes</span></a></li>
      <li class="header">MANAGE</li>
      <li class=""><a href="managers.php"><i class="fa fa-users"></i> <span>Hosts</span></a></li>
      ...
      <li class=""><a href="ballot.php"><i class="fa fa-black-tie"></i> <span>Ballots</span></a></li>
      <li class="header">Admin</li>
      <li class=""><a href="#config" data-toggle="modal"><i class="fa fa-cog"></i> <span>Election Title</span></a></li>
      <li class=""><a href="election.php"><i class="fa fa-users"></i> <span>Elections</span></a></li>
