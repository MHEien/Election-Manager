...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM positions INNER JOIN manager WHERE manager.election_id=positions.election_id";
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $sql = "SELECT *, candidates.id AS canid FROM candidates LEFT JOIN positions ON positions.id=candidates.position_id WHERE positions.election_id = candidates.election_id";
                $query = $conn->query($sql);
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                ...
                $sql = "SELECT voters_key as votkey FROM voters, positions WHERE voters_key NOT IN (SELECT voters_key FROM votes) AND positions.active = 'active' AND voters.election_id = '$election_id'";
                $query = $conn->query($sql);
            ...
            <a href="votesmissing.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
      ...
      <?php
        $sql = "SELECT * FROM positions INNER JOIN manager WHERE manager.election_id=positions.election_id ORDER BY priority ASC";
        $query = $conn->query($sql);
        $inc = 2;
...
<?php
  ...
  while($row = $query->fetch_assoc()){
    ...
    while($crow = $cquery->fetch_assoc()){
      ...
      $sql = "SELECT SUM(vote_weight) FROM votes WHERE candidate_id = '".$crow['id']."'";
      $vquery = $conn->query($sql);
      array_push($varray, $vquery->fetch_array()[0]);
    }
