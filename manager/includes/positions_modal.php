    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <label for="election_type" class="col-sm-3 control-label">Election Type</label>
                    <div class="col-sm-9">
                      <select class="form-control" id="election_type" name="election_type" required>
                        <option value="Person1">Person with abstain</option>
                        <option value="Person2">Person w/o abstain</option>
                        <option value="Statute1">Statute with abstain</option>
                        <option value="Statute2">Statute w/o abstain</option>
                      </select>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="max_vote" class="col-sm-3 control-label">Max Vote</label>
                    <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="positions_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_max_vote" class="col-sm-3 control-label">Max Vote</label>
                    <div class="col-sm-9">
